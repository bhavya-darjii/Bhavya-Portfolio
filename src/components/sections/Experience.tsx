...
export function Experience() {
  return (
    <section id="experience" className="px-4 py-24 md:px-6 md:py-32">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="relative space-y-6">
          <div className="absolute left-[23px] top-8 hidden h-[calc(100%-4rem)] w-px bg-gradient-to-b from-violet-500/50 via-cyan-500/30 to-transparent md:block" />

          {experience.map((job, i) => (
            <GlassCard key={job.company} delay={i * 0.1} className="md:ml-12">
              <div className="absolute -left-[3.25rem] top-8 hidden h-4 w-4 rounded-full border-2 border-violet-500 bg-[#0a0a12] shadow-lg shadow-violet-500/30 md:block" />

              <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
                <div className="flex items-start gap-3">
                  <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-violet-500/20 to-cyan-500/20">
