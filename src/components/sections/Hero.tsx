      ...
      <div className="w-full h-full">
        ...
        >
          <div className="relative flex min-h-screen flex-col">
            ...
            {/* MOBILE ONLY: meta text row pinned just below nav, above the photo */}
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 0.8, delay: 0.9 }}
              className="relative z-20 flex items-start justify-between px-6 pt-4 md:hidden"
            >
              <div>
            ...
            <div className="absolute bottom-0 left-0 right-0 z-10 flex justify-center">
              <motion.div
                ...
                className="w-[160%] h-[75dvh] ml-[8%] md:w-full md:h-[92vh] md:max-w-3xl lg:max-w-4xl md:ml-0"
              >
                <ProfileImage />
              </motion.div>
            </div>
